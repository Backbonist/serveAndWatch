...
// #### serve
//
// this one will use raw express (or just connect, should be enough) application with socket.io 
// connection setup.
//
...
module.exports = {
  ...
  addMiddleware: function addMiddleware(server, dirToWatch) {
    // path
    var dirname = path.resolve(dirToWatch);
